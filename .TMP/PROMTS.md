...
Мои предложения для исправления критической ошибки, при которой редактирование слота в Admin UI приводит к удалению конфигурации ролей (`role`) и поломке интеграции с провайдерами (Gemini).
