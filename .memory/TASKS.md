...
- [ ] EP PHC-3 — Фронтенд
  [ ] FEAT PHC-3.2 — UX Слотов  
       ...
       [ ] T PHC-3.2.4 — Реализовать боевые страницы логина/дашборда/настроек на основе шаблонов `login-page.html` и `main-page.html` из spec\docs\ui\frontend-examples.  Для `main-page.html` использовать цветовые стили из `frontend/stats/index.html`
       [ ] T PHC-3.2.5 — Валидация и подключение форм слотов к бэкенду.
       [ ] T PHC-3.2.6 — Подсветить поля форм слотов и настроек при ответах 422 (JSON ошибки)  
