...
- [ ] **4. Фаза 4 — Реализация серверного приложения (IMPL)**
  ...
  - *Задачи:*
    - [ ] 4.1 Завершить Ingest API.
      ...
      - [ ] 4.1.9 Добавить unit/contract тесты ingest (успех, неверный пароль, 415, 429, 504) и обновить фикстуры.
      - [ ] 4.1.10 Обновить документацию запуска ingest (пример curl, переменные окружения, политика TTL).
