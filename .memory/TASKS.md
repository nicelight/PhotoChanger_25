  ...
  - *Задачи:*
    ...
    - [ ] 4.5 Развернуть административную платформу (домен, безопасность, API).
      ...
      - [ ] 4.5.6 Подключить новые сервисы и репозитории в DI-контейнер, интегрировать `QueueWorker`/`JobService` с публикацией событий для `StatsService`.
        ...
        - [ ] 4.5.6e Синхронизировать контракт `ProcessingLog` между спецификациями и реализацией.
          - [ ] 4.5.6e1 Добавить JSON Schema `ProcessingLog` в `spec/contracts/schemas/`, обновить Docs/admin/stats.md и domain-модель.
          - [ ] 4.5.6e2 Обновить тесты/валидаторы, чтобы `ProcessingLog` и агрегаты соответствовали новому контракту.
