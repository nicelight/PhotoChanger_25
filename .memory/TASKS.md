...
## TODO
- [x] EP PHC-16 ? UI gpt-image-1.5: ??????????? aspect_ratio ? ??????? resolution
  [x] US PHC-16.GOV ? Governance & Discovery
    [x] T PHC-16.GOV.1 ? CONSULT ? ??????????? UX: ??????/disable resolution ? ?????????? aspect_ratio ?? 1:1/2:3/3:2
    [x] T PHC-16.GOV.2 ? REFLECT ? ????????? ????? ??? payload (size/output) ? ???????? ???????? UI
  [x] FEAT PHC-16.1 ? ?????????? UI ????? ??? gpt-image-1.5
    [x] T PHC-16.1.1 ? ???????? slot-ui/slot-mapping ??? ???????????
    [x] T PHC-16.1.2 ? ???????? template/slot-XXX ??? ?????????????
