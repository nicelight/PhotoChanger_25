...
## task-4.5.9-2025-11-09
- 2025-11-09 10:05 — старт работы над 4.5.9a/4.5.9b: перечитал openapi `GET/PUT /api/settings`, схемы `Settings*.json`, уточнил поля TTL и формат ошибок.
- 2025-11-09 10:45 — реализовал эндпоинты `GET/PUT /api/settings`: добавил зависимость на `SettingsService`, маппинг доменной модели в схемы, обработку ошибок 400/403/422 и временный отказ от `provider_keys`.

## task-4.5.9c-tests-2025-11-09
