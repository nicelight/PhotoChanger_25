...
- Миссия: обеспечить предсказуемый SLA ≤60 с для ingest-запросов, предоставить администраторам управляемые слоты и прозрачную статистику, а итоговые медиа хранить 168 ч (`.memory/MISSION.md`).
...
- Итоговые файлы доступны 168 ч (`T_result_retention`), затем удаляются автоматически; отклонения >15 мин считаются инцидентом.
